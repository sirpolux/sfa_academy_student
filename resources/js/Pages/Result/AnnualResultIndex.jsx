...
export default function AnnualResultIndex({ availableClasses, studentList, sessions }) {
        ...
        <GuestLayout>
            <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg overflow-hidden max-w-5xl mx-auto mt-10">
                ...
                <div className="md:w-1/2 p-6 md:p-10">
                    <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Annual Result</h2>
